<template>
  ...
  <div v-if="emailCheckedStatus !== 200">
    <div class="wrapper d-flex justify-content-center align-items-center">
      <div class="container">
        <h1>비밀번호 변경</h1>
        <form @submit.prevent="sendTemporaryPassword(email)" class="form">
          <input
            v-model="email"
            type="text"
            placeholder="Email"
          ...
          <button style="color: darkslategrey;" type="submit">확인</button>
          <br><br>
    
          <router-link style="color: darkslategrey; text-decoration: none;" :to="{ name: 'profile' }">음, 안 바꿀래요.</router-link>
        </form>
      </div>
