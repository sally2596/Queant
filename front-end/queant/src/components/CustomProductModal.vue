    ...
    <div class="modal-mask">
      ...
      <div class="modal-footer">
       <slot name="footer">
        ...
        <div v-else>
          <button v-if="!this.customDto" class="btn btn-outline-success btn-sm mx-3" disabled>등록</button>
          <button v-else class="btn btn-outline-success btn-sm mx-3" disabled>수정</button>
        </div>
