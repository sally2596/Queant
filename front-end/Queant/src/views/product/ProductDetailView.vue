<template>
  ...
  <!-- 내가 수정한곳 시작 -->
  <div class="container mt-4 mb-4 p-3 d-flex justify-content-center" id="content-header-section">
    <div class="card p-4">
      <div
            ...
            <dl>
              <dd class="subject">
                <div class="product-detail-sub">
                  <dl class="product-detail-sub-box">
                    <dt style="font-weight: bold; font-size: 120%;">은행사</dt>
                    <dd>
                      <br /><span
                        ><img v-bind:src="product?.product.picture" height="100" width="100"/></span
                      >
                    </dd>
                  </dl>
                  <br />
              ...
              <dd class="subject">
                <div class="product-detail-sub">
                  ...
                  <br />
                  <dl class="product-detail-sub-box">
                    <dt style="font-weight: bold; font-size: 120%;">최소 금리(세전)</dt>
              ...
              <dd class="foot">
                <div>
                  <dt style="font-weight: bold; font-size: 120%;">추가 금리 조건</dt>
                  <br>
